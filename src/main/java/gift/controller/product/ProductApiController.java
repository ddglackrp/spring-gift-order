...
public class ProductApiController {
    ...
    @GetMapping
    public ResponseEntity<List<ProductResponseDto>> getAllProducts(@RequestParam(name = "page", defaultValue = "0") int page,
        ...
        List<ProductResponseDto> productDtos = productService.findProductsUsingPaging(pageable, categoryId);
